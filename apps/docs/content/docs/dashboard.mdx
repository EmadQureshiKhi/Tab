...
<Cards>
  <Card title="Browse" href="http://localhost:3000/browse" external>
    Every priced tool, what it costs, and a call you can make.
  </Card>
  <Card title="Bind an address" href="http://localhost:3000/register" external>
    Prove you control an address on the Source Chain, by paying rather than by signing.
  </Card>
  <Card title="Register a Service" href="http://localhost:3000/services/new" external>
    Put your own tools on the rail and set their prices.
  </Card>
  <Card title="Post a Bond" href="http://localhost:3000/services/bond" external>
